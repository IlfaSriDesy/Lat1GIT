 ...
 * @author ASUS
 */
public class LayerDelapan {

 String data2_id, kd_produk, nm_produk, kategori_produk;
    double stok;

    public String getData2_id() {
        return data2_id;
    }

    public void setData2_id(String data2_id) {
        this.data2_id = data2_id;
    }
